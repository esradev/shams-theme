  ...
  <div class="max-w-4xl mx-auto px-4 pb-8">
    <!-- <div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
      ...
      <form class="mt-6 sm:flex sm:max-w-md lg:mt-0">
        ...
        <input type="text" name="phone-number" id="phone-number" autocomplete="off" required class="w-full min-w-0 appearance-none rounded-md border-0 bg-white px-3 py-1.5 text-base text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:w-56 sm:text-sm sm:leading-6" placeholder="شماره موبایل شما">
