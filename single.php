    ...
    <div class="mt-10 max-w-full prose">
      ...
      <div class="mt-6 flex gap-2 border border-x-0 py-4">
        <div class="flex-shrink-0">
          <a href="<?php echo $the_audio_of_the_lesson; ?>" download="true" class="inline-flex items-center text-sm font-medium text-indigo-600 gap-2 border border-indigo-600 rounded-lg px-4 py-2 no-underline hover:text-gray-50 hover:bg-indigo-600">
...
$the_audio_of_the_lesson = get_post_meta($post_id, 'the-audio-of-the-lesson', true);
?>
<div class="mt-10 flex flex-1">
  <audio controls class="w-full bg-gray-100 p-4 rounded-lg shadow">
