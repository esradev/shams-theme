...
<body <?php body_class(); ?> class="prose scroll-smooth overflow-x-hidden">
      ...
      <div class="flex h-16 justify-between">
        <div class="flex items-center lg:hidden">
          ...
          <button id="mobile-menu-button" type="button"
            ...
            <svg id='mobile-menu-open-icon' class="block h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" aria-hidden="true">
              <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
            </svg>
            <svg id='mobile-menu-close-icon' class="hidden h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" aria-hidden="true">
        ...
        <div class="flex px-2 lg:px-0">
          <div class="flex lg:flex-1 items-center justify-center">
            <a href="<?php echo home_url(); ?>">
              <img class="block h-8 w-auto" src="<?php echo get_site_icon_url(); ?>"
            ...
            <div class="mt-7 py-7 px-8 bg-white border-gray-200 drop-shadow-md">
              ...
              <p id="no-results-message" class="hidden text-red-600 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                  class="inline-block ml-2" viewBox="0 0 16 16">
                  <path
  ...
  <template id="li-template">
    <li><a class="flex items-center text-sm text-teal-700 hover:text-teal-500" href="#"><svg
          xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="mr-3"
          viewBox="0 0 16 16">
          <path
